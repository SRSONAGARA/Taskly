const TaskCard = ({ title, description, timeLeft, priority = "Medium", date, time }) => {
  return (
    ...
    >
      ...
      <div className="flex gap-2">
        <span className="text-xs px-2 py-1 rounded-full bg-red-100 text-red-500">High priority</span>
        <span className="text-xs px-2 py-1 rounded-full bg-green-100 text-green-600">{priority}</span>
      </div>
