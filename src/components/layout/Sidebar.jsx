    ...
    >
      ...
      <nav className="flex-1 px-2 py-8 w-full space-y-2 text-sm">
        {menu.map((item) => {
          ...
          ${collapsed ? "w-10 h-10 mx-auto flex items-center justify-center" : "flex items-center gap-3 px-3 py-2"}
      ...
      {!collapsed && (
        <div className="bg-indigo-50 rounded-xl p-4 mx-4 mb-6">
          ...
          <button className="w-full bg-indigo-600 text-white py-2 rounded-lg text-sm font-medium">Upgrade</button>
        </div>
      )}
